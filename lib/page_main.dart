...
{
  final String word_list_selected;

  const Page_Main({
    Key? key,
    required this.word_list_selected,
  }) : super(key: key);
...
class _Page_MainState extends State<Page_Main>
{
  ...
  {
    game_word = await word_retrive(widget.word_list_selected); // Pick word randomly
